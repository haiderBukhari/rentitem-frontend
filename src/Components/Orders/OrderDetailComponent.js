...
const OrderDetailComponent = ({ items }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex">
                <Link to={`/user/dashboard/order/${id}/${items._id}`} className="w-[210px] py-3 mt-3 mx-auto rounded-xl bg-primary text-white font-bold absolute text-center" style={{ bottom: "-20px", left: "37%" }}>
                    Check Details{" "}
                </Link>
            </div>
