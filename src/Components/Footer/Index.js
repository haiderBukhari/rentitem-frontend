...
const Footer = () => {
  ...
  return (
    <div className="bg-[#01A664] w-full min-h-[50vh] text-white pb-10">
      <div className="flex flex-col-reverse lg:flex-row items-center h-full ml-16">
        {screenWidth >= 800 &&
        ...
        <div className="flex items-center w-3/3 justify-between mt-5 lg:mt-0" style={{ flexDirection: screenWidth < 1021 ? 'column' : 'row' }}>
          <div className="mr-3">
            <h1 className="text-2xl mt-4 sm:mt-0 mb-2 font-bold">Account</h1>
          ...
          <div className="mr-3 mt-10 lg:mt-0">
            <h1 className="text-2xl mb-2 font-bold">Quick Link</h1>
            <div className="flex justify-center flex-col items-center">
          ...
          <div className="flex flex-col lg:mt-6">
            <h1 className="text-2xl mb-2 mt-10 ml-6 font-bold ">Categories</h1>
            <div className="flex justify-center flex-col items-center">
        ...
        <div className="lg:ml-auto pb-5 lg:pb-0">
          <img className="-mt-20 -pl-5 lg:-mt-40 w-auto" src={FooterImg} alt="" />
