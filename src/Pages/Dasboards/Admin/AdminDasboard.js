...
const AdminDasboard = () => {
    ...
    return (
        <div className='flex min-h-[100vh] max-w-[100vw] overflow-hidden'>
            <Sidebar>
                ...
                <div className="flex mt-24 mb-24 w-3/4 mx-auto items-center justify-center flex-wrap gap-10">
                    <div class="flex flex-col w-72">
                        ...
                        <div class="mt-4 text-left">
                            <h2 class="text-xl font-bold mb-2 text-center">Browse Users</h2>
                            <p class="text-base w-72 text-center">
                                Details of all Users and there products.
                            </p>
                            <Link
