  ...
  return (
    <div>
      ...
      <div className="mx-5 mt-6">
        <div class="relative">
          <img src={Category1} class="w-full h-[100%]" alt="" />
          <div class="absolute justify-center flex flex-col p-5 md:p-10 items-center w-[90%] md:w-[630px] h-auto top-5 left-5 md:left-20 rounded-[50px] shadow-[0px_4px_15px_#0b2f8a99] bg-gradient-to-b from-[rgba(244,244,244,0.4)] to-[rgba(244,244,244,0.2)] md:from-[rgba(244,244,244,0.2)] md:to-[rgba(244,244,244,0.2)]">
            <div class="font-bold text-lg md:text-[30px] text-white text-center">
              Elevate Your Electronics Game with Our Extensive Rental Options
            </div>
            <div class="text-white text-center text-[14px] md:text-[20px] hidden md:block md:text-sm lg:text-lg">
      ...
      <div className="px-5 mt-4 mb-5">
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-9 grid grid-cols-1 md:grid-cols-3 gap-6">
            {enableListView ? (
